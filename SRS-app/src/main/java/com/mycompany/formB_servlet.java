...
public class formB_servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        else { // EXECUTE DB INSERT QUERY AND RENDER LOGIN PAGE
    		DBConnection db = new DBConnection();
    		db.insertStudent(testobj.getUserID(), testobj.getPassword(), testobj.getFirstname(), testobj.getLastname(), 
    				testobj.getSS(), testobj.getEmail(), testobj.getAddress()); 
//    		ResultSet res = db.getResult();  
        	rd=request.getRequestDispatcher("reg-complete.jsp"); 
        }
