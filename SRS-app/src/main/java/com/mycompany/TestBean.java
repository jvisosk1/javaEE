...
public class TestBean {
	...
	public String url = "http://localhost:8080/SRS-app/";
	public String status_report = "";
//	public String datasource_name = "H2_DB_JNDI_3";
	...
	public void setLoginErrorMsg(String addError) {
		this.loginErrorMsg += addError;}
	public void clearLoginErrorMsg() {
		this.loginErrorMsg = "";}
